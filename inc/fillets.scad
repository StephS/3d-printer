...
module fillet_polar_i_n(outer_r, fillet_r, fillet_angle=90, fillet_fn=0, rotate_fn=0) {
  rotate_extrude(convexity=8, $fn=rotate_fn) {
    translate([outer_r, 0, 0]) {
      rotate(90,0,0) fillet_2d_i(fillet_r, fillet_angle, fillet_fn);
    }
  }
}
...
module cylinder_fillet_inside(h=10, r=10, top=3, bottom=3, $fn=0, fillet_fn=0, center=false){
	...
	cent=(center) ? -h/2 : 0;
	echo (c_fn);
    translate([0,0,cent]) difference() {
	    cylinder(h=h,r=r,$fn=c_fn);
	    
	    rotate ([0,0,rotfix]) {
	    fillet_polar_i_n(outer_r=r, fillet_r=bottom, fillet_angle=90, fillet_fn=fillet_fn, rotate_fn=c_fn);
	    translate([0,0,h])
	    mirror ([0,0,1])
	    fillet_polar_i_n(outer_r=r, fillet_r=top, fillet_angle=90, fillet_fn=fillet_fn, rotate_fn=c_fn);
		}
	}
}
...
module cylinder_fillet_outside(h=10, r=10, top=3, bottom=3, $fn=0, fillet_fn=0, center=false){
    ...
    translate([0,0,cent]) {
	    ...
	    rotate ([0,0,rotfix]) {
	    fillet_polar_i(inner_r=r, fillet_r=bottom, fillet_angle=90, fillet_fn=fillet_fn, rotate_fn=c_fn);
	    translate([0,0,h])
	    mirror ([0,0,1])
	    fillet_polar_i(inner_r=r, fillet_r=top, fillet_angle=90, fillet_fn=fillet_fn, rotate_fn=c_fn);
		}
	}
}
...
translate([-12,23,0])
cube_fillet_inside([20,20,20], vertical=[0,0,0,0], top=[3,3,3,3], bottom=[3,3,3,3], $fn=10);
