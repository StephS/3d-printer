	...
	difference() {
		union() {
			...
			translate([0, 0, motor_mount_thickness]) {
				...
				translate([0, 0, ((pulley[8] + pulley_height_from_motor)-motor_mount_thickness-y_idler_bearing[1]/2)*0.75]) cylinder(r=y_idler_bearing[0]/3, h=((pulley[8] + pulley_height_from_motor)-motor_mount_thickness-y_idler_bearing[1]/2)*0.25);
			}
